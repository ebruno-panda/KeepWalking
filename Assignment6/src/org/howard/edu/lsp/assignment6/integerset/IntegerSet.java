	    ...
	    set=list;
			...
			*/
			...
			public void union (IntegerSet intSetb) {
				...
				ArrayList<Integer> copyArrayList = set;  // create a getter for your native set.
...
//
//			    }
				copyArrayList.addAll(tempArrayList); 
...
//			// Set intersection
			public void intersect(IntegerSet intSetb){
				...
				ArrayList<Integer> tempArrayList = intSetb.getSet();  // create a getter for your set.
				set.retainAll(tempArrayList);
			} 
	//	
//			// Set difference, i.e., s1 –s2
			public void diff(IntegerSet intSetb) {  // set difference, i.e. s1 - s2
				ArrayList<Integer> tempArrayList = intSetb.getSet();  // create a getter for your set.
				ArrayList<Integer> copyArrayList = set;  // create a getter for your set.
...
//
//			    }
				copyArrayList.removeAll(tempArrayList); 
			}
	//	
